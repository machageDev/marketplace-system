# Generated by Django 5.2.7 on 2026-01-20 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category_scores', models.JSONField(blank=True, help_text='Per-category rating breakdown', null=True)),
                ('would_recommend', models.BooleanField(blank=True, default=None, null=True)),
                ('would_rehire', models.BooleanField(blank=True, default=None, null=True)),
                ('performance_tags', models.JSONField(blank=True, help_text='List of performance tags', null=True)),
                ('calculated_composite', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
